...
class d3slopechart extends d3chart {
  ...
  initChart() {
    ...
    // Vertical left axis
    this.startAxis = axisg
      .append('line')
      .attr(
        'class',
        'chart__axis-y chart__axis-y--slopechart chart__axis-y--start',
      )
      .attr('x1', 0)
      .attr('x2', 0)
      .attr('y1', 0)
    ...
    this.endAxis = axisg
      ...
      .attr(
        'class',
        'chart__axis-y chart__axis-y--slopechart chart__axis-y--end',
      )
      .attr('y1', 0)
      .attr('stroke', this.cfg.color.axis);
    ...
    if (this.cfg.axis.titles) {
      this.startl = axisg
        ...
        .attr(
          'class',
          'chart__axis-text chart__axis-text--slopechart chart__axis-text--start',
        )
        .attr('text-anchor', 'middle')
        .attr(
          'y',
          this.cfg.height + this.cfg.margin.top + this.cfg.margin.bottom - 12,
        )
      ...
      this.endl = axisg
        ...
        .attr(
          'class',
          'chart__axis-text chart__axis-text--slopechart chart__axis-text--end',
        )
        .attr('text-anchor', 'middle')
        .attr(
          'y',
  ...
  setChartDimension() {
    ...
    this.startAxis.attr('y2', this.cfg.height);
  ...
  setScales() {
    ...
    this.yScale
      ...
      .domain([
        d3.min(this.data, (d) =>
          d[this.cfg.values[0]] < d[this.cfg.values[1]]
            ? d[this.cfg.values[0]] * 0.9
            : d[this.cfg.values[1]] * 0.9,
        ),
        d3.max(this.data, (d) =>
          d[this.cfg.values[0]] > d[this.cfg.values[1]]
            ? d[this.cfg.values[0]] * 1.1
            : d[this.cfg.values[1]] * 1.1,
        ),
      ]);
    ...
    if (this.cfg.color.scheme) {
      if (this.cfg.color.scheme instanceof Array === true) {
        ...
        this.colorScale = d3
          .scaleOrdinal(d3[this.cfg.color.scheme])
          .domain(this.data.map((d) => d[this.cfg.key]));
      }
    }
  }
  ...
  enterElements() {
    ...
    newlines
      ...
      .classed(
        'chart__line--current',
        (d) => this.cfg.currentKey && d[this.cfg.key] == this.cfg.currentKey,
      )
    ...
    const gstart = newlines
      .append('g')
      .attr(
        'class',
        'chart__points-group chart__points-group--slopechart chart__points-group--start',
      );
    ...
    gstart
      ...
      .attr(
        'transform',
        (d) => 'translate(0,' + this.yScale(d[this.cfg.values[0]]) + ')',
      );
    ...
    gstart
      ...
      .attr(
        'class',
        'chart__point chart__point--slopechart chart__point--start',
      )
    ...
    gstart
      ...
      .attr(
        'class',
        'chart__label chart__label--slopechart chart__label--start',
      )
    ...
    const gend = newlines
      ...
      .attr(
        'class',
        'chart__points-group chart__points-group--slopechart chart__points-group--end',
      )
    ...
    gend
      ...
      .attr(
        ...
        (d) =>
          ...
          this.cfg.width +
          ',' +
          this.yScale(d[this.cfg.values[1]]) +
          ')',
      );
  ...
  updateElements() {
    ...
    this.linesgroup
      .selectAll('.chart__points-group--start')
      .data(this.data, (d) => d[this.cfg.key])
      .transition(this.transition)
      .attr(
        'transform',
    ...
    this.linesgroup
      .selectAll('.chart__points-group--end')
      .data(this.data, (d) => d[this.cfg.key])
      .transition(this.transition)
      .attr(
        'transform',
